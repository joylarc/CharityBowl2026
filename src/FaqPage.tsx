...
function Section({ id, emoji, title, children }: { id: string; emoji?: string; title: React.ReactNode; children: React.ReactNode }) {
  return (
    <Box id={id} sx={{ marginBottom: "2.5rem", scrollMarginTop: "1rem" }}>
      <Typography variant="h6" sx={{ fontWeight: "bold", marginBottom: "0.75rem" }}>
        {emoji && <>{emoji} </>}{title}
      </Typography>
...
function SectionHeader({ title }: { title: string }) {
  return (
    <Typography variant="h5" sx={{ fontWeight: "bold", marginTop: "3rem", marginBottom: "1.5rem", borderBottom: "3px solid #6ab648", paddingBottom: "0.5rem" }}>
      {title}
    </Typography>
  );
}
    ...
    <Box sx={{ minHeight: "100vh", backgroundColor: "#fff" }}>
      ...
      <Box sx={{ backgroundColor: "#00feff", textAlign: "center", padding: isSmall ? "1.5rem" : "2rem" }}>
        <img
          ...
          style={{ maxWidth: isSmall ? "200px" : "300px", height: "auto", marginBottom: "1rem" }}
        />
      ...
      <Container maxWidth="md" sx={{ padding: isSmall ? "1.5rem" : "2rem", color: "#222" }}>
        ...
        <Divider sx={{ borderColor: "#00feff", borderWidth: 2, marginBottom: "2rem" }} />
        ...
        {/* KEYS TO THE GAME */}
        <SectionHeader title="KEYS TO THE GAME [FOOTBALL TERM]" />

        <Section id="keys-to-the-game" emoji="🔑" title={<strong>The 2026 EDSBS Charity Bowl will kick off (football term) on Monday morning, April 20, at 10 a.m. ET,</strong>}>
        ...
        <Section id="" emoji="🔑" title={<strong>The <a href="https://bsky.app/profile/newap-georgia.bsky.social" target="_blank" style={link}>New AP Bluesky feed</a> will have the most up-to-date information during Bowl week</strong>}>
          regarding official stop/start times and scores. Our team of volunteers will be camped out there for a minimum of 12 hours each day to deliver scoring updates and celebrate especially creative donations and dedications from coast to coast.
        </Section>

        <Section id="" emoji="🔑" title={<strong>Money Cannon is back!</strong>}>
          Thanks to some incredibly generous friends of the program, last year we launched <a href="https://www.moneycannon.org" target="_blank" style={link}>MoneyCannon.org</a>, where you can view the latest Charitibundi Bowl scoring updates, see where your team ranks in conference standings, and even create your own custom leaderboards to track. You can read more about how Money Cannon works <a href="https://www.moneycannon.org/about.html" target="_blank" style={link}>here</a>.
        </Section>

        <Section id="" emoji="🔑" title={<strong>The Bowl Help Desk is back!</strong>}>
        ...
        <Section id="" emoji="🔑" title={<strong>New this year: Concierge team assignment services!</strong>}>
          Don't have a college football team? Spencer Hall is here for you, neighbor. Tell him a little bit about yourself, and he'll assign you a college football rooting interest. You can reach him <a href="https://bsky.app/profile/edsbs.bsky.social" target="_blank" style={link}>on Bluesky</a> or by emailing <a href="mailto:harumphharumph@gmail.com" style={link}>harumphharumph@gmail.com</a>. That's right: Spencer cares so much about this contest that he's agreed to read his own emails. Truly, we live in unprecedented times.
        </Section>

        <Section id="" emoji="🔑" title={<strong>From Monday morning on, <a href="https://www.edsbscharitybowl.com" target="_blank" style={link}>EDSBSCharityBowl.com</a> will be your home for everything else:</strong>}>
          A portal to submit your actual donations, a running grand total display of all the money we've raised so far, and links where you can learn more about New AP and their work.
        </Section>
        ...
        <Box id="how-to-play" sx={{ scrollMarginTop: "1rem" }}>
        ...
        <Section id="where-is-link" emoji="⁉️" title={<strong>Where is the link to donate?</strong>}>
          <>
            <p>Beginning on Monday morning, April 20, you'll see it at <a href="https://www.edsbscharitybowl.com" target="_blank" style={link}>EDSBSCharityBowl.com</a>. If you're reading this before April 20, that link is currently hidden for a reason. Here is that reason, in very large letters:</p>
        ...
        <Section id="executive-orders" emoji="⁉️" title={<strong>What's happening with New AP and refugees in the wake of recent executive orders?</strong>}>
          <>
            ...
            <p>For more about New AP's evolving mission in 2025 and beyond, see their <a href="/2025impactreport.pdf" target="_blank" style={link}>2025 impact report</a>. <a href="https://newamericanpathways.org/" target="_blank" style={link}>New AP's website</a> will be updated with the most current information regarding refugees entering America as events warrant.</p>
          </>
        </Section>
        ...
        <Section id="michigan-winning" emoji="⁉️" title={<strong>So how does Michigan keep winning?</strong>}>
          <>
            <p>The schools at the top of the leaderboard all tend to have one or two big-money donors bumping them up the ranks, but even at Michigan, <strong>the $20 donors outstrip everybody else by volume.</strong> The Wolverines keep winning because they have HORDES of donors. Wanna topple them this year? Do what they do: Get your friends involved.</p>
        ...
        <Section id="no-team" emoji="❌" title={<strong>I DON'T SEE MY TEAM IN THE DROPDOWN! BIAS!! HATERS!!! P E R F I D Y</strong>}>
          <>
            <p>A reminder that for this 20th edition of the Bowl, we're working with a new game format. You'll need to select an FBS football team or a team from our list of selected mid-majors along with your donation.</p>
        ...
        <Section id="recurring-gifts" emoji="❌" title={<strong>RECURRING GIFTS DO NOT ROLL OVER.</strong>}>
          <>
            <p>Some of you will remember from last year that, on the donation platform New AP uses, we have no way of rolling a recurring donation over from last year's contest to the 2026 campaign. Yes, it's a pain in the ass for us too. So. What does this mean for you?</p>
            <Box sx={{ textAlign: "center", padding: "1.5rem", backgroundColor: "#f5f5f5", borderLeft: "3px solid #c00", marginBottom: "1rem" }}>
              <Typography variant="h6" sx={{ fontWeight: "bold" }}>
                IF YOU SET UP A 2025 RECURRING GIFT AND WANT IT SCORED FOR 2026, YOU HAVE TO CANCEL IT AND MAKE A NEW PLEDGE.
              </Typography>
            </Box>
            <p>This is tedious! We're sorry about that! Please complete this form and the team at New AP will cancel future transactions you set up for the 2025 campaign. You will receive a confirmation email from New AP once it has been completed.</p>
          </>
        </Section>
        ...
        <Typography variant="body1" sx={{ lineHeight: 1.8, marginBottom: "3rem" }}>
